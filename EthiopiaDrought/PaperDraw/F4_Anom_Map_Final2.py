...
ax1.set_xticks([])
ax1.set_yticks([])
ax1.set_ylabel("{}".format(Year+startYear+6), fontdict={'fontname': 'Times New Roman', 'fontsize': 16})
...
fig.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_4V2.png',
