...
f2_ax1.set_xlabel("Seasonly EVI",fontdict={'fontname':'Times New Roman','fontsize':16})
...
f2_ax2.set_xlabel("Seasonly EVI",fontdict={'fontname':'Times New Roman','fontsize':16})
...
f2_ax3.set_xlabel("Seasonly EVI",fontdict={'fontname':'Times New Roman','fontsize':16})
...
f2_ax4.set_xlabel("Seasonly EVI",fontdict={'fontname':'Times New Roman','fontsize':16})
...
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2f.png',bbox_inches='tight',dpi=fig2.dpi,pad_inches=0.05)
