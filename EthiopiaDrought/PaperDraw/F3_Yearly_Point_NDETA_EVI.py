...
def GenValidRC():
    ...
    path = r"D:\Cornell\EthiopianDrought\0ExperimentData\ExtractPixelCSV\Agg_Mask50_Anom.csv"
    Var1List, Var2List, Var3List,  COL,ROW = ExtractVIFromCSV(path, "Short", "EVI", "RF", 2009)
...
ax.set_xlabel("EVI Anomaly in Bega")
...
ax2.set_xlabel("EVI Anomaly in bega")
...
ax3.set_xlabel("EVI Anomaly in krmet")
...
ax4.set_xlabel("EVI Anomaly in krmet")
...
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_3EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
plt.show()
