...
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2a_EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
...
plt.text(1, 0.1,'R = {} P = {}'.format(round(r_value,3),round(p_value,3)),fontdict={'fontname':'Times New Roman','fontsize':14},
     ...
     transform = plt.gca().transAxes)
plt.subplots_adjust(left=0.1,right=0.9,bottom=0,top=0.9,wspace=0.1,hspace=0.2)
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2b_EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
...
plt.text(1, 0.1,'R = {} P = {}'.format(round(r_value,3),round(p_value,3)),fontdict={'fontname':'Times New Roman','fontsize':14},
     ...
     transform = plt.gca().transAxes)
plt.subplots_adjust(left=0.1,right=0.9,bottom=0,top=0.9,wspace=0.1,hspace=0.2)
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2c_EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
...
plt.text(1, 0.9,'R = {} P = {}'.format(round(r_value,3),round(p_value,3)),fontdict={'fontname':'Times New Roman','fontsize':14},
     ...
     transform = plt.gca().transAxes)
plt.subplots_adjust(left=0.1,right=0.9,bottom=0,top=0.9,wspace=0.1,hspace=0.2)
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2d_EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
...
plt.xlabel('Year')
plt.ylabel("R")
plt.xticks(range(0,YearNum,5),[str(StartYear+y)[2:] for y in range(0,YearNum,5)])
plt.subplots_adjust(left=0.1,right=0.9,bottom=0,top=0.9,wspace=0.1,hspace=0.2)
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2e_EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
...
plt.subplots_adjust(left=0.1,right=0.9,bottom=0,top=0.9,wspace=0.1,hspace=0.2)
plt.savefig(r'D:\Cornell\EthiopianDrought\0ExperimentData\Fig\Fig_2f_EVI.png',bbox_inches='tight',dpi=fig.dpi,pad_inches=0.05)
