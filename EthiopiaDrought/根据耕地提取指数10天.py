...
def ExtractRainFall():
    ...
    for dt in (rrule.rrule(rrule.YEARLY, interval=1, dtstart=start, until=stop)):
        short_file = os.path.join(r"D:\Cornell\EthiopianDrought\AData\PVI10day",
                                  "short_pvi_{}.tif".format(dt.year))
        long_file = os.path.join(r"D:\Cornell\EthiopianDrought\AData\PVI10day",
...
outpath = r"D:\Cornell\EthiopianDrought\CropCSV\DailyCrop\10day\PolyGonAgg_Mask70.csv"
