...
def write_Img(data, path, im_width, im_heigth,im_bands=1, dtype=gdal.GDT_Float64):
    ...
    rainfall = gdal.Open(r"D:\Cornell\EthiopianDrought\CMIP5DailyClip\Big\cmip5_20060101.tif")
...
def PVI(chirpsdirectory,year):
    ...
    # return
    path = r'D:\Cornell\EthiopianDrought\AData\CMIP5PVI\Big'
...
for i in range(2006,2019):
    PVI(r"D:\Cornell\EthiopianDrought\CMIP5DailyClip\Big", i)