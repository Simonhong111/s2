...
def PVI(chirpsdirectory,year):
    ...
    # return
    path = r'D:\Cornell\EthiopianDrought\0ExperimentData\PVI_Data\PVI_4M_5D'
...
for i in range(2003,2019):
    PVI(r"D:\Cornell\EthiopianDrought\0ExperimentData\Precipitation_Data\P_Pentad_Average", i)