...
def monthComp(cmipclippeddirectory,outputdirectory,year,month):
    ...
    print(compdata[3,2])
    path = os.path.join(outputdirectory,r"cmip5_short_{}.tif".format(year))
    write_Img(compdata, path, proj, geotrans, 13, 20, im_bands=1, dtype=gdal.GDT_Float32)

for year in range(2006,2019):
    for month in range(1,13):
        monthComp(r"D:\Cornell\EthiopianDrought\CMIP5DailyClip\Big", r"D:\Cornell\EthiopianDrought\CMIPMonth\Big",
                  year, month)
# monthComp(r"D:\Cornell\EthiopianDrought\CMIP5DailyClip", r"D:\Cornell\EthiopianDrought\CMIPMonth",
#                   2006, "")
# raster = gdal.Open(r"D:\Cornell\EthiopianDrought\CMIP5DailyClip\cmip5_20060205.tif").ReadAsArray()
# print(raster[3,2])