...
path = r"D:\Cornell\EthiopianDrought\CropCSV\DailyCrop\5day\PolyGonAgg_Mask60.csv"
...
for Year in Years:
    ...
    for m in range(1, 7):
        ...
        ax.set_ylabel("PVI")
        if m <= 3:
            ax.text(0.5, 0.6, "R = {}".format(round(r_value, 3)), fontsize=16, color="r")
    ...
    path2 = os.path.join(r"D:\Cornell\EthiopianDrought\CropCSV\DailyCrop\5day\Image5", DataType + Year + "PVI60.jpg")
    plt.savefig(path2)
    plt.close()
