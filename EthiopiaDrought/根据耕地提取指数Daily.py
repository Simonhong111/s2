...
def ExtractRainFall():
    ...
    for dt in (rrule.rrule(rrule.YEARLY, interval=1, dtstart=start, until=stop)):
        short_file = os.path.join(r"D:\Cornell\EthiopianDrought\AData\PVIDaily",
                                  "short_pvi_{}.tif".format(dt.year))
        long_file = os.path.join(r"D:\Cornell\EthiopianDrought\AData\PVIDaily",
...
outpath = r"D:\Cornell\EthiopianDrought\CropCSV\DailyCrop\PolyGonAgg_Mask70.csv"
