...
def PentandAverage(pentandDir,outputdirectory):
    refpath = r"D:\Cornell\EthiopianDrought\CHIRPS5\chirps-v2.0.2003.01.1.tif"
    ...
    chirp_files = glob.glob(r"D:\Cornell\EthiopianDrought\CHIRPS5\chirps-v2.0.*.tif")
...
PentandAverage(r"D:\Cornell\EthiopianDrought\CHIRPS5",
               r"D:\Cornell\EthiopianDrought\Chirps5DAverage")
